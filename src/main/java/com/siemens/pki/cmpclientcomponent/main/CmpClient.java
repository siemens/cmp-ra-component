        ...
        try {
            ...
            if (attestationContext != null) {
                ...
                ratNonceResponse = requestHandler.sendReceiveInitialMessage(new PKIBody(
                        PKIBody.TYPE_GEN_MSG,
                        new GenMsgContent(
                                new InfoTypeAndValue(AttestationObjectIdentifiers.id_it_NonceRequest, nonceRequestValue))));
                ...
                if (itav != null) {
                    for (final InfoTypeAndValue aktitav : itav) {
                        if (AttestationObjectIdentifiers.id_it_NonceResponse.equals(aktitav.getInfoType())) {
                            ...
                            final NonceResponseValue ratNonce =
                            		NonceResponseValue.getInstance(infoValue);
                            ...
                            for (int i=0;i<nonceResponses.length;i++) {
                            	...
                            	attestationResult = attestationContext.getEvidenceStatement(ratNonce.get);
                            }
                ...
                case PKIBody.TYPE_INIT_REQ: {
                    ...
                    if (attestationResult != null) {
                        extensions.add(new Extension(
                                AttestationObjectIdentifiers.id_aa_evidence,
                                false,
