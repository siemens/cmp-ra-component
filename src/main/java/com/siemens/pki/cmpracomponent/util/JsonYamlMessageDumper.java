...
public class JsonYamlMessageDumper {
     ...
     */
    public static class ByteArrayInputStreamSerializer extends JsonSerializer<ByteArrayInputStream> {
        /**
         */
        @Override
        public Class<ByteArrayInputStream> handledType() {
     ...
     * Serializer for {@link ByteArrayInputStream}
     */
    public static class PKIBodySerializer extends JsonSerializer<PKIBody> {
     ...
     */
    public static class PollRepContentSeralizer extends JsonSerializer<PollRepContent> {
     ...
     */
    public static class ExtensionsSeralizer extends JsonSerializer<Extensions> {
    ...
    public static class ArraySerializer<T, U> extends JsonSerializer<T> {

        private final Class<T> handledType;

        private final BiFunction<Integer, T, U> getArray;

        private Function<T, Integer> sizeSupplier;

        public ArraySerializer(Class<T> handledType, Function<T, Integer> size, BiFunction<Integer, T, U> getArray) {
     ...
     */
    public static class GenericSerializer<T> extends JsonSerializer<T> {

        private final Class<T> handledType;

        private final Function<T, String> mapToString;

        public GenericSerializer(Class<T> handledType) {
            this.handledType = handledType;
            mapToString = T::toString;
        }

        public GenericSerializer(Class<T> handledType, Function<T, String> mapToString) {
            super();
            this.handledType = handledType;
     ...
     */
    public static class SubjectPublicKeyInfoSerializer extends JsonSerializer<SubjectPublicKeyInfo> {
