...
public interface GetFreshRatNonceHandler extends SupportMessageHandlerInterface {
    ...
    /**
     * get REST base path of Verifier
     * @return REST base path of Verifier
     */
    URI getBasePath();

    /**
     * get requested number of bytes of the returned nonce. Must be between 8 and 64.
     * @return number of bytes of the returned nonce
     */
    Integer getNonceSize();
}
