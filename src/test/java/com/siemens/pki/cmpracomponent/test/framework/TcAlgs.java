...
public class TcAlgs {
    ...
    public static List<Object[]> getCompositeAlgorithms() throws GeneralSecurityException, NoSuchAlgorithmException {
        return Arrays.asList(new Object[][] {
            {
    ...
    public static List<Object[]> getClassicSignatureAlgorithms()
