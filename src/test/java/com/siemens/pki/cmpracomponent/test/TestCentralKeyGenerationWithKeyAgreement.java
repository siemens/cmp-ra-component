...
public class TestCentralKeyGenerationWithKeyAgreement
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(TestCentralKeyGenerationWithKeyAgreement.class);
    ...
    public static List<Object[]> data() {
        ...
        for (final Object[] aktInput : inputList) {
            ...
            ret.add(new Object[] {keyAgreement, keyEncryption, keyAgreement,
                    keyEncryption});
        }
        return ret;
    }
    ...
    public TestCentralKeyGenerationWithKeyAgreement(
            ...
            final String keyEncryptionAsString, final String keyAgreementOID,
    ...
    public void setUp() throws Exception {
        ...
        eeCredentials = new SignatureBasedProtection(
                new TrustChainAndPrivateKey("credentials/CMP_EE_Keystore.p12",
    ...
    public void testCrWithKeyAgreement() throws Exception {
        executeCrmfCertificateRequestWithoutKey(PKIBody.TYPE_CERT_REQ,
                PKIBody.TYPE_CERT_REP, eeCredentials, getEeClient(),
                keyAgreementDecryptor);
    }

    @Test
    public void testKurWithKeyAgreement() throws Exception {
        executeCrmfCertificateRequestWithoutKey(PKIBody.TYPE_KEY_UPDATE_REQ,
                PKIBody.TYPE_KEY_UPDATE_REP, eeCredentials, getEeClient(),
                keyAgreementDecryptor);
    }
